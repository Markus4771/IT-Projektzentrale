...
8. `docs/security/SECURITY_REVIEW_1.0.0-beta.2.md`
9. `CHANGELOG.md`
...
- Beta 2 ist ein vorhandener Teststand; neue Funktionen müssen trotzdem mit Lastenheft und Architektur abgestimmt werden.
...
- Beta 2 nicht als produktionsreif bezeichnen, solange die dokumentierten Freigabepunkte offen sind.
